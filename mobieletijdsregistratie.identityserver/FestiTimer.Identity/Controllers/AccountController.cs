...
using FestiTimer.Identity.Extensions;
using FestiTimer.Identity.Models;
using IdentityModel;
...
namespace FestiTimer.Identity.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, IIdentityServerInteractionService interaction, IAuthenticationSchemeProvider schemeProvider, IClientStore clientStore, IEventService events, SignInManager<ApplicationUser> signInManager, ILogger<AccountController> logger)
        {
        ...
        public async Task<IActionResult> Register([FromBody]RegisterRequestViewModel model)
        {
            ...
            var user = new ApplicationUser { UserName = model.Email, FirstName = model.Name, Email = model.Email };
        ...
        {
            if (!qrCodeInput.IsImage()) return await QrCodeError(returnUrl);
        ...
        public async Task<IActionResult> QrCodeError(string returnUrl)
        {
            var vm = await BuildLoginViewModelAsync(returnUrl);
        ...
        public async Task<IActionResult> LoginQrCode(string userId, string returnUrl, string pincodeInput)
        {
            ...
            if (user.Pincode != HashEncoder.GetHashString(pincodeInput)) return await QrCodeError(returnUrl);
